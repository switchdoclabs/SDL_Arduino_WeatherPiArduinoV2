...
// Added support for V2 of the WeatherPiArduino Board
//
...
void setup()
{
  ...
  */
  ...
  Serial.println("----------------------");
  reportMyDevice("DS3231", DS3231Present);
  reportMyDevice("AS3935", AS3935Present);
  reportMyDevice("FRAM", FRAMPresent);
  reportMyDevice("BMP280", BMP280Present);
  reportMyDevice("AM2315", AM2315Present);
  reportMyDevice("HTU21DF", HTU21DFPresent);
...
void loop()
{
  ...
  if (timeElapsed > 5000)
  {
    ...
    {
      Serial.println("TempF: NOT FOUND");
      Serial.println("Hum:  NOT FOUND");
