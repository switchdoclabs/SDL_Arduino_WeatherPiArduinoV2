...
float voltageToDegrees(float value, float defaultWindDirection)
{
  ...
  // For 5V , use 1.0.  For 3.3V (or for ADS1015 or ADS1116)  use 0.66, For Grove Base Shield at 3.3V (required for WeatherPiArdunino) use 0.462
#define ADJUST3OR5 0.462
